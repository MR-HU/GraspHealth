 ...
 * 
 * @author HuGuojun
 * @date 2014-1-20 下午4:28:29
 * @modify
 * @version 1.0.0
 */
public class ModifyHeightActivity extends BaseActivity implements OnClickListener {
	...
	private class ModifyTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			pairs.add(new BasicNameValuePair("userHeight", nick));
			return HttpPostRequest.getDataFromWebServer(
					ModifyHeightActivity.this, "editMemberHeight", pairs);
		}
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (status == 0) {
					...
					user.setHeight(Integer.valueOf(nick));
					finish();
				} else {
