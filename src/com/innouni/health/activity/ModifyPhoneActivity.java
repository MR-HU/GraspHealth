...
public class ModifyPhoneActivity extends BaseActivity implements OnClickListener {
	...
	private void initView() {
		...
		titleContentView.setText("修改手机号码");
	...
	private class ModifyTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			pairs.add(new BasicNameValuePair("mobileNo", nick));
			return HttpPostRequest.getDataFromWebServer(
					ModifyPhoneActivity.this, "editMemberMobile", pairs);
		}
