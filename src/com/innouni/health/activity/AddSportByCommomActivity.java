 ...
 * @version 1.0.0
 */
public class AddSportByCommomActivity extends BaseActivity implements OnClickListener,
		TextWatcher, OnItemClickListener {

	private static final int PUSH = 0;
	private static final int CUSROMER = 1;
...
//			showDialog();
		...
		protected List<Object> doInBackground(Void... params) {
			...
			String json = HttpPostRequest.getDataFromWebServer(
					AddSportByCommomActivity.this, method, pairs);
...
//	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		intent.putExtra("activeSubTypeId", activite.getActiveSubType().toString());
		intent.putExtra("activeSubTypeName", activite.getActiveSubTypeName().toString());
		intent.putExtra("activeASlope", activite.getActiveASlope().toString());
		intent.putExtra("activeBInterept", activite.getActiveBInterept().toString());
		setResult(CommomFragment.RESULT_CODE, intent);
		finish();
	}
