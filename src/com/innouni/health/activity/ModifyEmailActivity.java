...
public class ModifyEmailActivity extends BaseActivity implements OnClickListener{
	...
	private class ModifyTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			pairs.add(new BasicNameValuePair("newEmail", nick));
			return HttpPostRequest.getDataFromWebServer(
					ModifyEmailActivity.this, "editMemberEmail", pairs);
		}
