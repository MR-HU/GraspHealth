 ...
 * 
 * @author HuGuojun
 * @date 2014-1-20 下午3:52:56
 * @modify
 * @version 1.0.0
 */
public class ModifyGenderActivity extends BaseActivity implements OnClickListener, OnCheckedChangeListener {
	...
	private void initView() {
		...
		titleContentView.setText("修改性别");
		titleRightBtn.setOnClickListener(this);
		titleRightBtn.setBackgroundResource(R.drawable.titlebar_finish_selector);
		
		group = (RadioGroup) findViewById(R.id.radio_member_gender);
	...
	private class ModifyTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			pairs.add(new BasicNameValuePair("sex", nick));
			return HttpPostRequest.getDataFromWebServer(
					ModifyGenderActivity.this, "editMemberSex", pairs);
		}
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (status == 0) {
					...
					user.setGender(Integer.valueOf(nick));
					finish();
				} else {
