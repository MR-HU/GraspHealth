...
/**
 * 菜品详情页<br>
 * 这个页面用于添加饮食的时候确认所要添加的饮食信息
 * 
 * @author HuGuojun
 * @date 2014-1-14 下午5:45:20
 * @modify
 * @version 1.0.0
 */
public class AddDietDishDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	private String foodId, mealsType, calory;
	...
	private class GetFoodDetailTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			return HttpPostRequest.getDataFromWebServer(
					AddDietDishDetailActivity.this, "getFoodDetail", pairs);
		}

		@Override
		protected void onPostExecute(String json) {
			System.out.println("饮食信息详情返回 : " + json);
			dialog.dismiss();
			task = null;
			try {
	...
	private void showDialog() {
		dialog = new ProgressDialog(AddDietDishDetailActivity.this);
	...
	private void initFoodList() {
		...
		for (int i = 0; i < array.length(); i++) {
			...
			RelativeLayout linear = new RelativeLayout(
					AddDietDishDetailActivity.this);
			RelativeLayout.LayoutParams rp = new RelativeLayout.LayoutParams(
					LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
			linear.setBackgroundResource(R.drawable.list_middle_click);
			linear.setLayoutParams(rp);

			TextView nameView = new TextView(AddDietDishDetailActivity.this);
			...
			TextView unitView = new TextView(AddDietDishDetailActivity.this);
			...
			TextView valueView = new TextView(AddDietDishDetailActivity.this);
	...
	public void onClick(View v) {
		...
		case R.id.btn_title_right:
			Intent intent = new Intent(this, AddDietStepFiveActivity.class);
			intent.putExtra("foodId", foodId);
			intent.putExtra("mealsType", mealsType);
			intent.putExtra("calory", calory);
			intent.putExtra("foodName", titleContentView.getText().toString()
					.trim());
