 ...
 * 
 * @author HuGuojun
 * @date 2014-1-20 下午4:31:54
 * @modify
 * @version 1.0.0
 */
public class ModifyWeightActivity extends BaseActivity implements OnClickListener {
	...
	private class ModifyTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			pairs.add(new BasicNameValuePair("userWeight", nick));
			return HttpPostRequest.getDataFromWebServer(
					ModifyWeightActivity.this, "editMemberWeight", pairs);
		}
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (status == 0) {
					...
					user.setWeight(Integer.valueOf(nick));
					finish();
				} else {
