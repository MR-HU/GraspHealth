package com.innouni.health.widget;
...
public class PullToRefreshView extends LinearLayout {
	...
	/**
	 * 初始化AdapterView,比如ListView,GridView或者ScrollView
	 */
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			// 如果只需要下拉刷新或者上拉加载中的一个功能可以再次过滤
			// if(deltaY >0 && isRefreshViewScroll(deltaY))可以过滤上拉加载
			// if(deltaY <0 && isRefreshViewScroll(deltaY))可以过滤下拉刷新
